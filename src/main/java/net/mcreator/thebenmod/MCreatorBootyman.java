...
public class MCreatorBootyman extends Elementsthebenmod.ModElement {
	public static final int ENTITYID = 5;
	public static final int ENTITYID_RANGED = 6;

	public MCreatorBootyman(Elementsthebenmod instance) {
		super(instance, 8);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("thebenmod", "bootyman"), ENTITYID).name("bootyman").tracker(21, 1, true).egg(-1, -1).build());
	}
	...
	public static class EntityCustom extends EntityMob {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("thebenmod:ben.bruh.gay"));
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("thebenmod:gay.gay"));
		}
